<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Demo6.aspx.cs" Inherits="JavaScript_plugins_MapAPI_Demo6" %>
...
<body>
    ...
    <script type="text/javascript">
        ...
        drawingManager.enableEditing();//开启编辑
        ...
        var aaArrt = [];
        aaArrt.push(new BMap.Point(113.957716, 22.542661));
        aaArrt.push(new BMap.Point(113.960878, 22.52824))
        aaArrt.push(new BMap.Point(113.977838, 22.533648))
        aaArrt.push(new BMap.Point(113.974676, 22.541192))
        aaArrt.push(new BMap.Point(113.964831, 22.547935))

        function showPolygon(btn) {
            
            var polygon = new BMap.Polygon(aaArrt, styleOptions);  //创建多边形    
